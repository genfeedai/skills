...
description: Score existing offers against the Value Equation and prescribe fixes for outcome, proof, time-to-results, effort, bonus stack, and guarantee. Triggers on offer validation, offer ratings, launch readiness, low conversions, and offer audits.
license: MIT
metadata:
  author: genfeedai
  version: 1.0.0
...
| Genfeed content-reviewer | Validate sales copy |
