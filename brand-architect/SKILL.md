...
description: 'Create brand foundations: name, positioning, voice, and strategic identity. Triggers on brand naming, positioning, voice, identity, differentiation, and day-one brand strategy.'
license: MIT
metadata:
  author: genfeedai
  version: 1.0.0
...
- Genfeed copywriter - Brand-consistent copy
