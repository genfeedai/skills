---
name: email-finder
description: Find and verify contact emails associated with a domain using free discovery methods first and APIs when keys are available. Triggers on domain email scans, contact discovery, email pattern finding, and email enrichment.
license: MIT
metadata:
  author: genfeedai
  version: 1.0.0
...
- Genfeed copywriter - Use found emails for outreach campaigns
