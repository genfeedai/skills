...
description: Design retention, activation, ascension, upsell, cross-sell, subscription, churn reduction, and LTV systems. Triggers on customers leaving, reducing churn, recurring revenue, subscription optimization, upsells, cross-sells, and repeat purchases.
license: MIT
metadata:
  author: genfeedai
  version: 1.0.0
...
| Genfeed copywriter | Write retention/upgrade communications |
