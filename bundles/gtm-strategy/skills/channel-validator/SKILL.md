...
description: Validate channel focus against the One Channel Rule before adding more platforms or tactics. Triggers on channel sprawl, platform focus, right-channel questions, and expansion readiness.
license: MIT
metadata:
  author: genfeedai
  version: 1.0.0
