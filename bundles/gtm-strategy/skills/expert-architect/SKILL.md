...
description: 'Build expert positioning for a person or founder: attractive character, origin story, Big Domino, authority signals, and new opportunity framing. Triggers on personal brand positioning, origin stories, authority building, and expert narratives.'
license: MIT
metadata:
  author: genfeedai
  version: 1.0.0
...
- What mechanism makes your way work?

### Step 6: Create Authority Stack
...
### Step 7: Assemble Positioning Statement
...
| Genfeed content-reviewer | Validate how positioning translates to copy |
...
- If user needs to **validate positioning** → `expert-validator`
- If user needs to **validate copy** → Genfeed content-reviewer
...
| Genfeed copywriter | Write the landing page and messaging from the positioning work |
