...
description: Validate domain syntax, check availability assumptions, and generate brandable domain options from naming criteria. Triggers on domain validation, domain availability, domain search, brandable domains, and naming checks.
license: MIT
metadata:
  author: genfeedai
  version: 1.0.0
