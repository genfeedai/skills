...
description: 'Build scalable support and customer success systems: help docs, FAQs, ticketing, self-service, automation, response templates, and deflection workflows. Triggers on too many support requests, help center setup, support scaling, ticketing, FAQs, and self-service.'
license: MIT
metadata:
  author: genfeedai
  version: 1.0.0
  tags: business, support, customer-success, helpdesk, faq, automation, self-service
---
...
| Genfeed copywriter | Write clear, helpful docs |
...
- If you need **help writing docs** → Genfeed copywriter
