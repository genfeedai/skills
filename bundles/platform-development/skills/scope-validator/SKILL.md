...
description: Classify feature requests as Genfeed OSS Core or Cloud SaaS scope and explain the contribution or subscription path. Triggers on core vs cloud, OSS contribution, node scope, provider scope, and feature request triage.
license: MIT
metadata:
  author: genfeedai
  version: 1.0.0
  tags: genfeed, scope, oss, cloud, contribution
---
