...
description: Design sales funnels, value ladders, customer journeys, and landing page sequences from scratch. Triggers on funnel design, value ladder mapping, funnel type selection, and conversion path planning.
license: MIT
metadata:
  author: genfeedai
  version: 1.0.0
...
3. [ ] Write copy (use Genfeed content-reviewer to check)
...
| Genfeed content-reviewer | Validate funnel copy |
